...
function Dashboard() {
  ...
  useEffect(() => {
    api
      ...
      .catch(() => setSummary({ total_surat: 0, surat_baru: 0, total_arsip: 0 }));
  }, []);
  ...
  return (
    <DashboardLayout title="Dashboard Pimpinan">
      ...
      <div className="stats-grid">
        <div className="stat-card" onClick={() => navigate("/pimpinan/surat-masuk")}>
        ...
        <div className="stat-card" onClick={() => navigate("/pimpinan/surat-masuk")}>
          ...
          <div>
            <p>Perlu Disposisi</p>
            <h3>{summary.surat_baru}</h3>
            <span><Clock size={14} /> Perlu ditindaklanjuti</span>
          </div>
        </div>

        <div className="stat-card" onClick={() => navigate("/pimpinan/arsip")}>
          <div className="stat-icon green"><Archive size={25} /></div>
          <div>
            <p>Arsip Digital</p>
            <h3>{summary.total_arsip}</h3>
            <span><CheckCircle size={14} /> Arsip tersimpan</span>
          </div>
        </div>
      </div>
